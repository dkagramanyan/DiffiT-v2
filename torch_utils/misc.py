...
# Miscellaneous utility functions for PyTorch.
...
def constant(value, shape=None, dtype=None, device=None, memory_format=None):
    """Create a constant tensor with caching to avoid CPU=>GPU copy."""
...
def params_and_buffers(module):
    """Get all parameters and buffers from a module."""
    assert isinstance(module, torch.nn.Module)
    return list(module.parameters()) + list(module.buffers())


def named_params_and_buffers(module):
    """Get all named parameters and buffers from a module."""
    assert isinstance(module, torch.nn.Module)
    return list(module.named_parameters()) + list(module.named_buffers())


def copy_params_and_buffers(src_module, dst_module, require_all=False):
    """Copy parameters and buffers from src_module to dst_module."""
