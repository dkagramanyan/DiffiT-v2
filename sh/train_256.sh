...
#
# Workstation:  bash sh/train_256.sh               (detaches; output goes to logs/)
#               FOREGROUND=1 bash sh/train_256.sh  (stays attached; output also goes to logs/)
...
# environment (DATA=<zip> GPUS=<n> bash sh/train_256.sh). Anything after the script name
